...
public class Process implements Runnable {
    ...
    private int tiempoBloqueadoRestante = 0;
    ...
    public void step(){
        programCounter++;
        setMemoryAddressRegister(getMemoryAddressRegister() + 1);
        executedCycles++;
    ...
    // MÉTODOS NUEVOS:
    public int getTiempoBloqueadoRestante() {
        return tiempoBloqueadoRestante;
    }

    public void setTiempoBloqueadoRestante(int tiempoBloqueadoRestante) {
        this.tiempoBloqueadoRestante = tiempoBloqueadoRestante;
    }
}